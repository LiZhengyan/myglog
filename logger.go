...
const (
	...
	LmyglogFlags  = LstdFlags | Lmicroseconds | Lshortfile | Lmsgprefix | Lmsglevel
)

var myglog = New(os.Stderr, WithCallDepth(4), WithFlags(LmyglogFlags))
...
func SetFlags(flag int) {
	myglog.SetFlags(flag)
}

// Prefix returns the output prefix for the standard logger.
func Prefix() string {
	return myglog.Prefix()
}

// SetPrefix sets the output prefix for the standard logger.
func SetPrefix(prefix string) {
	myglog.SetPrefix(prefix)
}
...
func SetLevel(level Level) {
	myglog.SetLevel(level)
}

func LevelLength() uint8 {
	return myglog.LevelLength()
}

func SetLevelLength(length uint8) {
	myglog.SetLevelLength(length)
}

func CallDepth() int {
	return myglog.CallDepth()
}

func SetCallDepth(calldepth int) {
	myglog.SetCallDepth(calldepth)
}

func AutoCallDepth() {
	myglog.AutoCallDepth()
}

func ResetCallDepth() {
	myglog.SetCallDepth(4)
}

// Writer returns the output destination for the standard logger.
func Writer() io.Writer {
	return myglog.Writer()
}
...
func Tracef(format string, v ...interface{}) {
	myglog.Tracef(format, v...)
}

func Debugf(format string, v ...interface{}) {
	myglog.Debugf(format, v...)
}

func Infof(format string, v ...interface{}) {
	myglog.Infof(format, v...)
}

func Noticef(format string, v ...interface{}) {
	myglog.Noticef(format, v...)
}

func Warnf(format string, v ...interface{}) {
	myglog.Warnf(format, v...)
}

func Warningf(format string, v ...interface{}) {
	myglog.Warningf(format, v...)
}

func Errorf(format string, v ...interface{}) {
	myglog.Errorf(format, v...)
}

func Criticalf(format string, v ...interface{}) {
	myglog.Criticalf(format, v...)
}

func Fatalf(format string, v ...interface{}) {
	myglog.Fatalf(format, v...)
}

func Panicf(format string, v ...interface{}) {
	myglog.Panicf(format, v...)
}

func Output(level Level, format string, v ...interface{}) error {
	return myglog.Output(level, format, v...)
}
